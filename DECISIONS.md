...
最終更新: 2026-06-09（メニュー単機能化 段1＋業販対応2-2a 本番反映）
...
| 業販対応（法人/個人で明細の見せ方を変える） | 🚧 第一歩・第二歩-1・2-2a 本番反映済 | main | 法人受注で業販価格（定価×掛け率）が明細に入る計算まで完成。次=明細の見た目（個人=金額1列／法人=業販+定価）＋PDF（段2/第二歩-3） |
