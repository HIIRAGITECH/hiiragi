...
最終更新: 2026-06-09（業販対応 段2-1 明細画面 本番反映）
...
| 業販対応（法人/個人で明細の見せ方を変える） | 🚧 第一歩・第二歩-1・2-2a・段2-1 本番反映済。残るはPDF（段2-2）のみ | main | 明細画面は完成（個人=内容/数量/単価/小計、法人=単価/業販/参考定価＋合計欄に参考定価税込併記）。OrderItemにlist_price保存。次=段2-2（PDF 2ファイルを個人/法人で分岐＋文言）。これで業販対応完成 |
